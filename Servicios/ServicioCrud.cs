...
using ApiGenerica.Servicios.Abstracciones;             // Para IServicioCrud e IPoliticaTablasProhibidas
using ApiGenerica.Repositorios.Abstracciones;          // Para IRepositorioLecturaTabla
    ...
    public class ServicioCrud : IServicioCrud
    {
        ...
        )
        {
            ...
            try
            {
                ...
                bool contrasenaCorrecta = ApiGenerica.Servicios.Utilidades.EncriptacionBCrypt.Verificar(

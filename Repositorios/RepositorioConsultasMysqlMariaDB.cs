...
// Ruta      : ApiGenerica/Repositorios/RepositorioConsultasMysqlMariaDB.cs
...
using ApiGenerica.Repositorios.Abstracciones;      // IRepositorioConsultas
using ApiGenerica.Servicios.Abstracciones;         // IProveedorConexion

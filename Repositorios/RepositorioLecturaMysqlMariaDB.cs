...
using ApiGenerica.Repositorios.Abstracciones;      // Contrato IRepositorioLecturaTabla
using ApiGenerica.Servicios.Abstracciones;         // Contrato IProveedorConexion
using ApiGenerica.Servicios.Utilidades;            // EncriptacionBCrypt

...
using System.Text;
using ApiGenerica.Modelos; // donde está ConfiguracionJwt
...
builder.Services.AddSingleton<
    ApiGenerica.Servicios.Abstracciones.IPoliticaTablasProhibidas,
    ApiGenerica.Servicios.Politicas.PoliticaTablasProhibidasDesdeJson>();

// -----------------------------------------------------------------
// REGISTRO DE SERVICIO CRUD (DIP)
// -----------------------------------------------------------------
builder.Services.AddScoped<
    ApiGenerica.Servicios.Abstracciones.IServicioCrud,
    ApiGenerica.Servicios.ServicioCrud>();

// -----------------------------------------------------------------
// REGISTRO DEL PROVEEDOR DE CONEXIÓN (DIP)
// -----------------------------------------------------------------
builder.Services.AddSingleton<
    ApiGenerica.Servicios.Abstracciones.IProveedorConexion,
    ApiGenerica.Servicios.Conexion.ProveedorConexion>();
...
// -----------------------------------------------------------------
builder.Services.AddScoped<ApiGenerica.Servicios.Abstracciones.IServicioConsultas,
    ApiGenerica.Servicios.ServicioConsultas>();
...
switch (proveedorBD.ToLower())
{
    case "postgres":
        ...
        builder.Services.AddScoped<ApiGenerica.Repositorios.Abstracciones.IRepositorioLecturaTabla,
                                   ApiGenerica.Repositorios.RepositorioLecturaPostgreSQL>();
        // Repositorio de consultas para PostgreSQL
        builder.Services.AddScoped<
            ApiGenerica.Repositorios.Abstracciones.IRepositorioConsultas,
            ApiGenerica.Repositorios.RepositorioConsultasPostgreSQL
        >();
        break;
    ...
    case "mysql":
        ...
        builder.Services.AddScoped<
            ApiGenerica.Repositorios.Abstracciones.IRepositorioLecturaTabla,
            ApiGenerica.Repositorios.RepositorioLecturaMysqlMariaDB>();

        // Repositorio de consultas para MySQL/MariaDB
        builder.Services.AddScoped<
            ApiGenerica.Repositorios.Abstracciones.IRepositorioConsultas,
            ApiGenerica.Repositorios.RepositorioConsultasMysqlMariaDB>();
        break;
    ...
    default:
        ...
        builder.Services.AddScoped<ApiGenerica.Repositorios.Abstracciones.IRepositorioLecturaTabla,
                                   ApiGenerica.Repositorios.RepositorioLecturaSqlServer>();

        // Repositorio de consultas para SQL Server
        builder.Services.AddScoped<ApiGenerica.Repositorios.Abstracciones.IRepositorioConsultas,
                               ApiGenerica.Repositorios.RepositorioConsultasSqlServer>();
        break;
}
...
app.UseSwaggerUI(c =>
{
    c.SwaggerEndpoint("/swagger/v1/swagger.json", "ApiGenerica v1");
